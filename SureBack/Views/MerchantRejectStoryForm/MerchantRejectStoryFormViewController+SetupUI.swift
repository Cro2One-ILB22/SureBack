...
extension MerchantRejectStoryFormViewController {
    ...
    private func setupTitle1() {
        let hStackView = UIStackView(arrangedSubviews: [reasonForRejectTextLabel, closeImage])
    ...
    private func setupQuestion1Label() {
        ...
        question1TextLabel.setTopAnchorConstraint(equalTo: reasonForRejectTextLabel.bottomAnchor, constant: 16)
